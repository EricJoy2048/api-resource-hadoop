...
import org.opensource.hadoop.clustermanager.fromrestapi.util.ApplicationFinalState;
import org.opensource.hadoop.clustermanager.fromrestapi.util.JsonToBeanTools;
import org.opensource.hadoop.clustermanager.fromrestapi.util.ResourceManagerParam;
...
//		}
	...
	private String getAppByIdUrl(String appId){
		String url = getResourceUrl(ResourceType.YARN_APP_LIST_URL);
		url = url + "/" + appId;
		return url;
	}
	...
	public Application getAppById(String appId) {
		String url = getAppByIdUrl(appId);
		String rpString = null;
